...
shape.insert('segiempat', '5', 'segiempatgenjang', text = "Jajar Genjang")
shape.insert('segiempatgenjang', 'end', 'segiempat_beraturan', text = "Segiempat beraturan")
shape.insert('segiempatgenjang', 'end', 'segiempat_layang', text = "Layang-layang")
shape.insert('segiempat', '6', 'segiempat_trapesium', text = "Trapesium")
shape.insert('segiempat_trapesium', 'end', 'segiempat_trapesium_samakaki', text = "Trapesium sama kaki")
shape.insert('segiempat_trapesium', 'end', 'segiempat_trapesium_ratakanan', text = "Trapesium rata kanan")
shape.insert('segiempat_trapesium', 'end', 'segiempat_trapesium_ratakiri', text = "Trapesium rata kiri")
